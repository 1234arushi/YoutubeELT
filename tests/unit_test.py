...
def test_dags_integrity(dagbag):
    #if any error return the message otherwise empty dict means no error
    #assert does not return value just checks the condition if false then throws error with message & next line never runs
